<template>
  <article>
    ...
    <hr
      style="margin-left: 17.5vw; margin-right: 17.5vw; background-color: #552fbc"
    />
    <center>
      <div id="donateCards" class="columns is-centered is-multiline">
        <div
